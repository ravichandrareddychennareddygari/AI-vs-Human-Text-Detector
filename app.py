...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            elif perplexity > 20000 and burstiness_score > 0.25:
                st.success("Text Analysis Result: Likely Human Written Content")
            elif perplexity > 20000 and burstiness_score <= 0.25:
                st.warning("Text Analysis Result: Possibly AI Generated Content")
            else:  # perplexity <= 20000 and burstiness_score > 0.25
                st.info("Text Analysis Result: Likely Mixed AI and Human Content")

            
            st.warning("Disclaimer: Our AI Detector is advanced, but no detectors are 100% reliable, no matter what their accuracy scores claim. Never use AI detection alone to make decisions that could impact a person's career or academic standing. AI plagiarism detector apps can assist in identifying potential instances of plagiarism; however, it is important to note that their results may not be entirely flawless or completely reliable. These tools employ advanced algorithms, but they can still produce false positives or false negatives. Therefore, it is recommended to use AI plagiarism detectors as a supplementary tool alongside human judgment and manual verification for accurate and comprehensive plagiarism detection.")

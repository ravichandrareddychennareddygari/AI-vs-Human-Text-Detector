    ...
    if st.button("Analyze"):
        ...
        with col2:
            ...
            if perplexity <= 20000 and burstiness_score <= 0.25:
                st.error("Text Analysis Result: AI-Generated")
            elif perplexity > 20000 and burstiness_score > 0.25:
                st.success("Text Analysis Result: Human-Written")
            elif perplexity > 20000 and burstiness_score <= 0.25:
                st.warning("Text Analysis Result: Possibly AI-Assisted")
            else:  # perplexity <= 20000 and burstiness_score > 0.25
                st.info("Text Analysis Result: Mixed AI and Human")
